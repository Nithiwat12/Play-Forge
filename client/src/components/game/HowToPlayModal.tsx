...
const HOW_TO_PLAY: Record<string, HowToPlayContent> = {
  spyfall: {
    ...
    steps: [
      ...
      {
        emoji: "🗳️",
        text: "ใครก็ได้กดปุ่ม \"ขอเปิดโหวต\" เมื่อคิดว่ารู้แล้วว่าใครเป็นสปาย - ทุกคน (สปายด้วย) จะได้ป๊อปอัปให้ตอบรับ/ปฏิเสธ ถ้าเสียงส่วนมากเห็นด้วยถึงจะเข้าสู่โหมดโหวต ถ้าไม่ถึงเสียงส่วนมาก จะเล่นต่อและต้องรอ 2 นาทีก่อนขอใหม่ได้",
      },
      {
        emoji: "✅",
      ...
      { emoji: "⏱️", text: "โหมดโหวตมีเวลาจำกัด 5 นาที ถ้าหมดเวลาก่อนจะสรุปผลจากสิ่งที่มีอยู่ตอนนั้นทันที และถ้าโหวตเสมอกันตั้งแต่ 2 คนขึ้นไป จะได้เวลาพิเศษเพิ่มอีก 5 นาทีเพื่อคุยกันต่อ" },
    ],
  },
};
