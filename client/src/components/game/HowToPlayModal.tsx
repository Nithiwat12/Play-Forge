...
const HOW_TO_PLAY: Record<string, HowToPlayContent> = {
  ...
  wordhead: {
    ...
    steps: [
      ...
      {
        emoji: "✅",
        text: "คนอื่นในห้อง (ที่เห็นคำ) เป็นคนกดยืนยันว่าคำตอบนั้นถูกหรือยัง - กด \"ตอบถูก\" เพื่อจบตานั้นเลย หรือกด \"ยังไม่ถูก\" เพื่อให้ทายต่อ ถ้าเจ้าของตาพิมพ์คำตอบ จะมีป๊อปอัปเด้งขึ้นมาเตือนให้คนอื่นกดยืนยันทันที",
      },
      {
        emoji: "🏳️",
